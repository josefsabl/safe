 ...
 * @param  $return_path Use this parameter to specify return path upon mail delivery failure.
 * This is useful when using PHP as a mail client for multiple users.
 * @throws ImapException
 * 
 */
function imap_mail(string $to, string $subject, string $message, string $additional_headers = null, string $cc = null, string $bcc = null,  $return_path = null): void
{
    error_clear_last();
 ...
 * @param int $options Connection parameters, the following (string) keys maybe used 
 ...
 * 
 */
function imap_open(string $mailbox, string $user, string $password, int $flags = 0, int $retries = 0, int $options = [])
{
    error_clear_last();
