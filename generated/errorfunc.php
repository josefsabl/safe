 ...
 * @param  $additional_headers The extra headers. It's used when the message_type
 ...
 * 
 */
function error_log(string $message, int $message_type = 0, string $destination = null,  $additional_headers = null): void
{
    error_clear_last();
