 ...
 * 
 */
function oci_connect(string $username, string $password,  $connection_string = null, string $encoding = "", int $session_mode = OCI_DEFAULT)
{
    error_clear_last();
 ...
 * 
 * @param resource $statement A valid OCI statement identifier.
 * @param  $column Can be the field's index (1-based) or name.
 ...
 * 
 */
function oci_new_connect(string $username, string $password,  $connection_string = null, string $encoding = "", int $session_mode = OCI_DEFAULT)
{
    error_clear_last();
 ...
 * 
 */
function oci_pconnect(string $username, string $password,  $connection_string = null, string $encoding = "", int $session_mode = OCI_DEFAULT)
{
    error_clear_last();
