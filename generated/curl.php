 ...
 * @param string $value One of the CURL_LOCK_DATA_* constants.
 * @throws CurlException
 * 
 */
function curl_share_setopt(\CurlShareHandle $share_handle, int $option, string $value): void
{
    error_clear_last();
