 ...
 * 
 */
function ldap_add(\LDAP\Connection $ldap, string $dn, array $entry,  $controls = null): void
{
    error_clear_last();
 ...
 * 
 */
function ldap_bind(\LDAP\Connection $ldap,  $dn = null,  $password = null): void
{
    error_clear_last();
 ...
 * 
 */
function ldap_count_entries(\LDAP\Connection $ldap,  $result): int
{
    error_clear_last();
 ...
 * 
 */
function ldap_delete(\LDAP\Connection $ldap, string $dn,  $controls = null): void
{
    error_clear_last();
 ...
 * 
 */
function ldap_exop_whoami(\LDAP\Connection $ldap): string
{
    error_clear_last();
 ...
 * @param string $response_data Will be filled with the extended operation response data if provided.
 * If not provided you may use ldap_parse_exop on the result object
 * later to get this data.
 * @param string $response_oid Will be filled with the response OID if provided, usually equal to the request OID.
 ...
 * 
 */
function ldap_mod_add(\LDAP\Connection $ldap, string $dn, array $entry,  $controls = null): void
{
    error_clear_last();
 ...
 * 
 */
function ldap_mod_del(\LDAP\Connection $ldap, string $dn, array $entry,  $controls = null): void
{
    error_clear_last();
 ...
 * 
 */
function ldap_mod_replace(\LDAP\Connection $ldap, string $dn, array $entry,  $controls = null): void
{
    error_clear_last();
 ...
 * 
 */
function ldap_modify_batch(\LDAP\Connection $ldap, string $dn, array $modifications_info,  $controls = null): void
{
    error_clear_last();
 ...
 * 
 */
function ldap_parse_exop(\LDAP\Connection $ldap,  $result, string &$response_data = null, string &$response_oid = null): void
{
    error_clear_last();
 ...
 * 
 */
function ldap_parse_result(\LDAP\Connection $ldap,  $result, int &$error_code, string &$matched_dn = null, string &$error_message = null, ?array &$referrals = null, array &$controls = null): void
{
    error_clear_last();
 ...
 * 
 */
function ldap_rename(\LDAP\Connection $ldap, string $dn, string $new_rdn, string $new_parent, bool $delete_old_rdn,  $controls = null): void
{
    error_clear_last();
 ...
 * 
 */
function ldap_sasl_bind(\LDAP\Connection $ldap,  $dn = null, string $password = null,  $mech = null,  $realm = null,  $authc_id = null,  $authz_id = null, string $props = null): void
{
    error_clear_last();
 ...
 * 
 * @param  $ldap Either an LDAP\Connection instance, returned by
