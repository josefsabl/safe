...
{
    error_clear_last();
    $result = \rnp_dump_packets_to_json($input, $flags);
    if ($result === false) {
        throw RnpException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \rnp_dump_packets($input, $flags);
    if ($result === false) {
        throw RnpException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \rnp_ffi_create($pub_format, $sec_format);
    if ($result === false) {
        throw RnpException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \rnp_import_keys($ffi, $input, $flags);
    if ($result === false) {
        throw RnpException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \rnp_import_signatures($ffi, $input, $flags);
    if ($result === false) {
        throw RnpException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \rnp_key_export_autocrypt($ffi, $key_fp, $subkey_fp, $uid, $flags);
    if ($result === false) {
        throw RnpException::createFromPhpError();
    }
    return $result;
...
function rnp_key_export_revocation(\RnpFFI $ffi, string $key_fp, int $flags, array $options = null)
{
    error_clear_last();
    if ($options !== null) {
        $result = \rnp_key_export_revocation($ffi, $key_fp, $flags, $options);
    }else {
        $result = \rnp_key_export_revocation($ffi, $key_fp, $flags);
    }
    if ($result === false) {
        throw RnpException::createFromPhpError();
    }
...
{
    error_clear_last();
    $result = \rnp_key_export($ffi, $key_fp, $flags);
    if ($result === false) {
        throw RnpException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \rnp_key_get_info($ffi, $key_fp);
    if ($result === false) {
        throw RnpException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \rnp_key_remove($ffi, $key_fp, $flags);
    if ($result === false) {
        throw RnpException::createFromPhpError();
    }
}
...
function rnp_key_revoke(\RnpFFI $ffi, string $key_fp, int $flags, array $options = null): void
{
    error_clear_last();
    if ($options !== null) {
        $result = \rnp_key_revoke($ffi, $key_fp, $flags, $options);
    }else {
        $result = \rnp_key_revoke($ffi, $key_fp, $flags);
    }
    if ($result === false) {
        throw RnpException::createFromPhpError();
    }
...
{
    error_clear_last();
    $result = \rnp_list_keys($ffi, $identifier_type);
    if ($result === false) {
        throw RnpException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \rnp_load_keys_from_path($ffi, $format, $input_path, $flags);
    if ($result === false) {
        throw RnpException::createFromPhpError();
    }
}
...
{
    error_clear_last();
    $result = \rnp_load_keys($ffi, $format, $input, $flags);
    if ($result === false) {
        throw RnpException::createFromPhpError();
    }
}
...
{
    error_clear_last();
    $result = \rnp_locate_key($ffi, $identifier_type, $identifier);
    if ($result === false) {
        throw RnpException::createFromPhpError();
    }
    return $result;
...
function rnp_op_encrypt(\RnpFFI $ffi, string $message, array $recipient_keys_fp, array $options = null)
{
    error_clear_last();
    if ($options !== null) {
        $result = \rnp_op_encrypt($ffi, $message, $recipient_keys_fp, $options);
    }else {
        $result = \rnp_op_encrypt($ffi, $message, $recipient_keys_fp);
    }
    if ($result === false) {
        throw RnpException::createFromPhpError();
    }
...
function rnp_op_generate_key(\RnpFFI $ffi, string $userid, string $key_alg, string $sub_alg = null, array $options = null)
{
    error_clear_last();
    if ($options !== null) {
        $result = \rnp_op_generate_key($ffi, $userid, $key_alg, $sub_alg, $options);
    } elseif ($sub_alg !== null) {
        $result = \rnp_op_generate_key($ffi, $userid, $key_alg, $sub_alg);
    }else {
        $result = \rnp_op_generate_key($ffi, $userid, $key_alg);
    }
    if ($result === false) {
        throw RnpException::createFromPhpError();
    }
...
function rnp_op_sign_cleartext(\RnpFFI $ffi, string $data, array $keys_fp, array $options = null)
{
    error_clear_last();
    if ($options !== null) {
        $result = \rnp_op_sign_cleartext($ffi, $data, $keys_fp, $options);
    }else {
        $result = \rnp_op_sign_cleartext($ffi, $data, $keys_fp);
    }
    if ($result === false) {
        throw RnpException::createFromPhpError();
    }
...
function rnp_op_sign_detached(\RnpFFI $ffi, string $data, array $keys_fp, array $options = null)
{
    error_clear_last();
    if ($options !== null) {
        $result = \rnp_op_sign_detached($ffi, $data, $keys_fp, $options);
    }else {
        $result = \rnp_op_sign_detached($ffi, $data, $keys_fp);
    }
    if ($result === false) {
        throw RnpException::createFromPhpError();
    }
...
function rnp_op_sign(\RnpFFI $ffi, string $data, array $keys_fp, array $options = null)
{
    error_clear_last();
    if ($options !== null) {
        $result = \rnp_op_sign($ffi, $data, $keys_fp, $options);
    }else {
        $result = \rnp_op_sign($ffi, $data, $keys_fp);
    }
    if ($result === false) {
        throw RnpException::createFromPhpError();
    }
...
{
    error_clear_last();
    $result = \rnp_op_verify_detached($ffi, $data, $signature);
    if ($result === false) {
        throw RnpException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \rnp_save_keys_to_path($ffi, $format, $output_path, $flags);
    if ($result === false) {
        throw RnpException::createFromPhpError();
    }
}
...
{
    error_clear_last();
    $result = \rnp_save_keys($ffi, $format, $output, $flags);
    if ($result === false) {
        throw RnpException::createFromPhpError();
    }
}
...
{
    error_clear_last();
    $result = \rnp_supported_features($type);
    if ($result === false) {
        throw RnpException::createFromPhpError();
    }
    return $result;
