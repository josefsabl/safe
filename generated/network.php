 ...
 * DNS_*
 * constants.
 * @param array $authoritative_name_servers Passed by reference and, if given, will be populated with Resource
 * Records for the Authoritative Name Servers.
 * @param array $additional_records Passed by reference and, if given, will be populated with any
 * Additional Records.
 ...
 * unix://.
 * @param int $error_code If provided, holds the system level error number that occurred in the
