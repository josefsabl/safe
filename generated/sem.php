 ...
 * 
 * 
 * @param int $error_code If the function fails, the optional error_code
 ...
 * later on.
 * @param int $error_code If the function fails, the optional errorcode will be set to the value of the system errno variable.
 * @throws SemException
 * 
 */
 ...
 * 
 */
function sem_get(int $key, int $max_acquire = 1, int $permissions = 0666, int $auto_release = true)
{
    error_clear_last();
 ...
 * @param  $size The memory size. If not provided, default to the
