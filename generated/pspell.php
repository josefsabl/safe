 ...
 * 
 * 
 * @param \PSpell\Dictionary $dictionary An PSpell\Dictionary instance.
 * @param string $word The added word.
 * @throws PspellException
 * 
 */
function pspell_add_to_personal(\PSpell\Dictionary $dictionary, string $word): void
{
    error_clear_last();
 ...
 * 
 */
function pspell_add_to_session(\PSpell\Dictionary $dictionary, string $word): void
{
    error_clear_last();
 ...
 * 
 */
function pspell_clear_session(\PSpell\Dictionary $dictionary): void
{
    error_clear_last();
 ...
 * 
 */
function pspell_config_data_dir(\PSpell\Config $config, string $directory): void
{
    error_clear_last();
 ...
 * 
 */
function pspell_config_dict_dir(\PSpell\Config $config, string $directory): void
{
    error_clear_last();
 ...
 * 
 * 
 * @param \PSpell\Config $config An PSpell\Config instance.
 * @param int $min_length Words less than min_length characters will be skipped.
 * @throws PspellException
 * 
 */
function pspell_config_ignore(\PSpell\Config $config, int $min_length): void
{
    error_clear_last();
 ...
 * 
 */
function pspell_config_mode(\PSpell\Config $config, int $mode): void
{
    error_clear_last();
 ...
 * 
 */
function pspell_config_personal(\PSpell\Config $config, string $filename): void
{
    error_clear_last();
 ...
 * 
 */
function pspell_config_repl(\PSpell\Config $config, string $filename): void
{
    error_clear_last();
 ...
 * 
 */
function pspell_config_runtogether(\PSpell\Config $config, bool $allow): void
{
    error_clear_last();
 ...
 * 
 */
function pspell_config_save_repl(\PSpell\Config $config, bool $save): void
{
    error_clear_last();
 ...
 * 
 */
function pspell_save_wordlist(\PSpell\Dictionary $dictionary): void
{
    error_clear_last();
 ...
 * 
 */
function pspell_store_replacement(\PSpell\Dictionary $dictionary, string $misspelled, string $correct): void
{
    error_clear_last();
