 ...
 * handling.
 * 
 * @param  $id If id is specified and not NULL, it will replace the current
 ...
 * 
 * @param  $module If module is specified and not NULL, that module will be
 * used instead.
 ...
 * 
 * @param  $name The session name references the name of the session, which is 
 ...
 * 
 * @param  $path Session data path. If specified and not NULL, the path to which data is saved will
