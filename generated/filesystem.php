 ...
 * @param string $separator The separator parameter sets the field separator.
 * It must be a single byte character.
 * @param string $enclosure The enclosure parameter sets the field enclosure character.
 * It must be a single byte character.
 * @param string $escape The escape parameter sets the escape character.
 ...
 * @param  $length Maximum length of data read. The default is to read until end
 ...
 * @param int $would_block The optional third argument is set to 1 if the lock would block
 ...
 * @param  $mtime The touch time. If mtime is NULL, 
 ...
 * 
 */
function touch(string $filename,  $mtime = null, int $atime = null): void
{
    error_clear_last();
