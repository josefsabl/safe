 ...
 * 
 */
function sodium_crypto_aead_aegis128l_decrypt(string $ciphertext, string $additional_data, string $nonce, string $key)
{
    error_clear_last();
    $result = \sodium_crypto_aead_aegis128l_decrypt($ciphertext, $additional_data, $nonce, $key);
    if ($result === false) {
 ...
 * 
 */
function sodium_crypto_aead_aegis256_decrypt(string $ciphertext, string $additional_data, string $nonce, string $key)
{
    error_clear_last();
    $result = \sodium_crypto_aead_aegis256_decrypt($ciphertext, $additional_data, $nonce, $key);
    if ($result === false) {
        throw SodiumException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \sodium_crypto_stream_xchacha20_xor_ic($message, $nonce, $counter, $key);
    if ($result === false) {
        throw SodiumException::createFromPhpError();
    }
    return $result;
