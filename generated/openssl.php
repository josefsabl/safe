...
{
    error_clear_last();
    $result = \openssl_cipher_key_length($cipher_algo);
    if ($result === false) {
        throw OpensslException::createFromPhpError();
    }
    return $result;
 ...
 * 
 * @param string|resource $csr See CSR parameters for a list of valid values.
 * @param string $output on success, this string will contain the PEM
 * encoded CSR
 * @param bool $no_text 
 * The optional parameter notext affects
 * the verbosity of the output; if it is FALSE, then additional human-readable
 ...
 * @param  $private_key private_key should be set to a private key that
 ...
 * @param  $options By default, the information in your system openssl.conf
 ...
 * 
 * 
 * @param  $extra_attributes extra_attributes is used to specify additional
 ...
 * 
 */
function openssl_csr_new(array $distinguished_names,  &$private_key,  $options = null,  $extra_attributes = null)
{
    error_clear_last();
 ...
 * @param  $ca_certificate The generated certificate will be signed by ca_certificate.
 * If ca_certificate is NULL, the generated certificate
 * will be a self-signed certificate.
 * @param  $private_key private_key is the private key that corresponds to
 * ca_certificate.
 * @param int $days days specifies the length of time for which the
 * generated certificate will be valid, in days.
 * @param  $options You can finetune the CSR signing by options.
 ...
 * 
 */
function openssl_csr_sign( $csr,  $ca_certificate,  $private_key, int $days,  $options = null, int $serial = 0,  $serial_hex = null)
{
    error_clear_last();
    $result = \openssl_csr_sign($csr, $ca_certificate, $private_key, $days, $options, $serial, $serial_hex);
    if ($result === false) {
        throw OpensslException::createFromPhpError();
    }
    return $result;
 ...
 * @param  $private_key The private key used for decrypting encrypted_key.
 ...
 * 
 * @param  $certificate See Key/Certificate parameters for a list of valid values.
 * @param string $output_filename Path to the output file.
 * @param  $private_key Private key component of PKCS#12 file.
 ...
 * @param  $certificate Either a lone X.509 certificate, or an array of X.509 certificates.
 ...
 * @param  $certificate The X.509 certificate used to digitally sign input_filename.
 * See Key/Certificate parameters for a list of valid values.
 * @param  $private_key private_key is the private key corresponding to certificate.
 * See Public/Private Key parameters for a list of valid values.
 * @param array $headers headers is an array of headers that
 ...
 * @param  $untrusted_certificates_filename untrusted_certificates_filename specifies the name of a file containing
 * a bunch of extra certificates to include in the signature which can for
 * example be used to help the recipient to verify the certificate that you used.
 * @throws OpensslException
 * 
 */
function openssl_pkcs7_sign(string $input_filename, string $output_filename,  $certificate,  $private_key, array $headers, int $flags = PKCS7_DETACHED,  $untrusted_certificates_filename = null): void
{
    error_clear_last();
 ...
 * 
 * @param  $public_key public_key is the public key for the derivation.
 * See Public/Private Key parameters for a list of valid values.
 * @param  $private_key private_key is the private key for the derivation.
 * See Public/Private Key parameters for a list of valid values.
 ...
 * passphrase.
 * @param  $options options can be used to fine-tune the export
 ...
 * 
 */
function openssl_pkey_export_to_file( $key, string $output_filename, string $passphrase = null,  $options = null): void
{
    error_clear_last();
 ...
 * 
 */
function openssl_pkey_export( $key, string &$output, string $passphrase = null,  $options = null): void
{
    error_clear_last();
 ...
 * 
 * @param  $private_key private_key can be one of the following:
 * 
 ...
 * functions.
 * 
 * @param  $public_key public_key can be one of the following:
 * 
 ...
 * 
 * @param  $options It is possible to fine-tune the key generation (e.g. specifying the number of
 ...
 * @param  $private_key private_key must be the private key that corresponds
 ...
 * @param string $data 
 * @param string $decrypted_data 
 * @param  $public_key public_key must be the public key that corresponds
 ...
 * @param bool $strong_result If passed into the function, this will hold a bool value that determines
 ...
 * 
 * 
 * @param string $iv The initialization vector for decryption of data. It is required if
 ...
 * signature.
 * @param  $private_key OpenSSLAsymmetricKey - a key, returned by openssl_get_privatekey
 * 
 * string - a PEM formatted key
 * @param  $algorithm int - one of these Signature Algorithms.
 * 
 ...
 * @param  $public_key OpenSSLAsymmetricKey - a key, returned by openssl_get_publickey
 * 
 ...
 * it.
 * 
 * @param  $certificate X509 certificate. See Key/Certificate parameters for a list of valid values.
